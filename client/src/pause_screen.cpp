...
void pause_screen_init(tgui::Gui &gui) {
    ...
    return_back_button->onPress(
        [&gui]() { show_screen(gui, screen_id.at(screen::GAME_SCREEN), screen_id.at(screen::PAUSE)); });
    ...
    start_button->onPress(
        [&gui]() { show_screen(gui, screen_id.at(screen::START_SCREEN), screen_id.at(screen::PAUSE)); });
