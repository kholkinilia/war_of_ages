...
const unit_stats &unit::get_stats(unit_type type) noexcept {
    const static std::unordered_map<unit_type, unit_stats> stats{
        {unit_type::PEASANT, unit_stats(2, 50, 0.5, 0, 25, 25, {100, 200}, 100)},
        {unit_type::ARCHER, unit_stats(3, 70, 1, 500, 30, 50, {100, 200}, 100)},
        {unit_type::CHARIOT, unit_stats(4, 100, 1.5, 0, 40, 100, {200, 160}, 150)},
